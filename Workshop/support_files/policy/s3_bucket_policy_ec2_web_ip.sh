...
# variable
INPUT_FILE="$HOME/Workshop/support_files/policy/s3_bucket_policy_ec2_web_ip.json"
OUTPUT_FILE="$HOME/Workshop/support_files/policy/s3_bucket_policy_ec2_web_ip_output.json"
