...
# variable
INPUT_FILE="$HOME/Workshop/support_files/policy/s3_bucket_policy_ec2_web_role.json"
OUTPUT_FILE="$HOME/Workshop/support_files/policy/s3_bucket_policy_ec2_web_role_output.json"
